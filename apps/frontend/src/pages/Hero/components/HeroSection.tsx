...
export default function HeroSection() {
  ...
  const careLines = [
    { letter: "C", word: t("care.c"), indent: "pl-25" },
    { letter: t("care.aLetter"), word: t("care.a"), indent: "pl-31" },
    { letter: "R", word: t("care.r"), indent: "pl-37" },
    { letter: "E", word: t("care.e"), indent: "pl-43" },
  ];
